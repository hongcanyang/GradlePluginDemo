...
class RClassUtil {
            ...
            ClassVisitor classVisitor = new ClassVisitor(Opcodes.ASM5) {
                ...
                FieldVisitor visitField(int access, String name, String desc, String signature, Object value) {
                    if (value instanceof Integer) {
                        //遍历读取所有 R.class 里的 int 常量值，
                        println "需要收集的R类信息：fullClassName = ${fullClassName}" + " name = ${name}  <---> value = ${value}"
            ...
            MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
                ...
                methodVisitor = new MethodVisitor(Opcodes.ASM5, methodVisitor) {
                    ...
                    void visitFieldInsn(int opcode, String owner, String name1, String desc1) {
                        ...
                        if (value != null) {
                            if (key.contains("com/example/gradledemo/R")) {
                            }
     ...
     *
     * @param classFilePath class文件的全路径名，例如：~app/build/intermediates/classes/debug/com/example/gradledemo/R.class
    ...
    /**
     * 从形如 ~/HM-ThinApk/app/build/intermediates/classes/debug/com/example/gradledemo/R.class 的类路径中截取出 com/example/gradledemo/R.class
     ...
     * @return 返回类似 "com/example/gradledemo/R.class"、"com/example/gradledemo/R$mipmap.class"，其实就是类的全路径class名
     */
